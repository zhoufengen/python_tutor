...
print("从索引1开始取到10-1=9位置的元素9个元素：")
print("L[1:10]=", L[1:10])

print("从索引1开始取到11-1=10的元素10个元素：")
print("L[1:11]=", L[1:11])

print("全list，每隔2-1=1个元素取一个元素")
print("L[::2]=", L[::2])

print("从索引1开始，到索引11-1=10，每隔1个元素取一个元素")
print("L[1:11:]=", L[1:11:])

print("从索引1开始，到索引11-1=10，每隔3-1=2个元素取一个元素")
print("L[1:11:3]=", L[1:11:3])

print("从索引1开始，到索引11，每隔3-1=2个元素取一个元素，取倒序")
print("L[1:11:3][::-1]=", L[1:11:3][::-1])

print("从索引0开始，到索引11-1=10，取到了11-0=11个元素：")
print(L[0:11])
print("从索引1开始，到索引11-1=10，取到11-1=10个元素：")
print(L[1:11])
